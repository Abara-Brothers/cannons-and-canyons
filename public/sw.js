...
// Bumped with every ?v= asset stamp (cc-v4 = ?v=4: offline modes, native
// sign-in, badges), so activate() drops the old cache outright and a returning
...
const SHELL = [
  ...
  'styles.css?v=4',
  'bay.js?v=4',          // the Launch Bay front end
